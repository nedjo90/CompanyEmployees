...
public static class ServiceExtensions
{
    ...
    public static void ConfigureSwagger(this IServiceCollection services)
    {
        services.AddSwaggerGen(s =>
        {
            ...
            string xmlFile = $"{typeof(Presentation.AssemblyReference).Assembly.GetName().Name}.xml";
            string xmlPath = Path.Combine(AppContext.BaseDirectory, "../../../../CompanyEmployees.Presentation",xmlFile);
